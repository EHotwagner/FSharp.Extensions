...
type SourceWindowControl() as this = 
    ...
    let welcomeMessage = ""
                          + "//\n"
                          + "// Welcome to the SourceWindow sample. This hosts the F# compiler services in Silverlight\n"
                          + "//\n"
                          + "// * As you type, information about your script will be shown in the window below.\n"
                          + "//\n"
                          + "/// This is a sample value\n"
                          + "let sampleValue = 1\n"
                          + "\n"
                          + "/// This is a sample function\n"
                          + "let sampleFunction x = x + 1\n"
                          + "\n"
                          + "/// This is a sample union type\n"
                          + "type SampleUnionType = A of int | B of string\n"
                          + "\n"
                          + "/// This is a sample class type\n"
                          + "type SampleClassType(dx:double, dy:double) = \n"
                          ...
                          + "    member x.Scale k = SampleClassType(dx*k, dy*k)\n"
                          + "\n"
    ...
    let standardOpts =  [| "--noframework"; "-r:mscorlib.dll"; "-r:FSharp.Core.dll"; "-r:System.Core.dll"; "-r:System.Net.dll"  |]
