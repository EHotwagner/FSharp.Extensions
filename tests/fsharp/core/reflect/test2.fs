...
module NewTests = 
    ...
    do test "ncqmkee32ao8" (FSharpValue.PreComputeRecordConstructor(typeof<string PublicRecordType2>) [| box "1"; box 1 |] = box {r2b = "1"; r2a = 1 })
    ...
    module RepeatTestsWithShowAll  =
        ...
        do test "ncqmkee32ao8" (FSharpValue.PreComputeRecordConstructor(typeof<string PublicRecordType2>,showAll) [| box "1"; box 1 |] = box {r2b = "1"; r2a = 1 })
