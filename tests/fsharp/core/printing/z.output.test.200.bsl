...
type F1 =
  class
    ...
    member D : x:int -> y:int -> z:int -> int list
    override ToString : unit -> string
    member D2 : int
    member E : int
...
type Either<'a,'b> =
  | This of 'a
  | That of 'b
val catch : (unit -> 'a) -> Either<'a,(string * string)>
...
> val it : 'a -> 'a = <fun:clo@756-3>
> 
val fff : 'a -> 'a

> val it : ('a -> 'a) = <fun:clo@758-4>
> 
...
stdin(763,17): error FS0438: Duplicate method. The method 'M' has the same name and signature as another method in this type.
> 
...
stdin(770,17): error FS0438: Duplicate method. The method 'get_P' has the same name and signature as another method in this type.
...
stdin(824,20): error FS0361: The override 'M : string -> int' implements more than one abstract slot, e.g. 'abstract member Regression4232.D.M : 'U -> int' and 'abstract member Regression4232.D.M : 'T -> int'
> val it : string =
