...
findstr /v "%CD%" z.raw.output.test.default.txt > z.output.test.default.txt
findstr /v "%CD%" z.raw.output.test.1000.txt    > z.output.test.1000.txt
findstr /v "%CD%" z.raw.output.test.200.txt     > z.output.test.200.txt
findstr /v "%CD%" z.raw.output.test.off.txt     > z.output.test.off.txt
findstr /v "%CD%" z.raw.output.test.quiet.txt   > z.output.test.quiet.txt
...
set PRDIFF=%FSHARP_HOME%\tools\win86\diff.exe
